...
class CouchModel extends coffee_model.Model
  ...
  constructor:(args...)->
    ...
    for arg in args
      switch typeof arg
        ...
        when 'string'
          ...
          throw new Error 'invalid arg to CouchModel.constructor:'+(typeof arg)
    ...
    # super does not work!
    # when you use functions attached during the constructor!
    # so...we can not override "get" or "set" or anything !
    # will have to live with that


    r = super data
    # super works only for the constrcutor function
...
exports.truncate_date = coffee_model.truncate_date
